...
// usuario consegue editar:
// nome de usuario //
test('nao foi possivel alterar o usuario', async ()=>{
    ...
    const responseUser = await fetch(`http://localhost:3000/usuarios/user/${idUsuario}`, {method: "PUT",headers: {'Accept': 'application/json',
    'Content-Type': 'application/json'},body:JSON.stringify({"username" :novoUsername})})
...
test('nao foi possivel alterar a senha', async ()=>{
    ...
    const responseSenha = await fetch(`http://localhost:3000/usuarios/senha/${idUsuario}`, {method: "PUT",headers: {'Accept': 'application/json',
    'Content-Type': 'application/json'},body:JSON.stringify({"senha":novaSenha})})
...
// senha do usuario//
test('nao foi possivel alterar o email', async ()=>{
    ...
    const responseEmail = await fetch(`http://localhost:3000/usuarios/email/${idUsuario}`, {method: "PUT",headers: {'Accept': 'application/json',
    'Content-Type': 'application/json'},body:JSON.stringify({"email" : novoEmail})})
...
test('nao foi possivel deletar a conta', async ()=>{
    ...
    const responseDelete = await fetch(`http://localhost:3000/usuarios/${idUsuario}`, {method: "DELETE",headers: {'Accept': 'application/json',
    'Content-Type': 'application/json'}})
